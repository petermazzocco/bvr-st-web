...
import { AccountPaymentHistoryCard } from "@/components/cards/account-payment-history-card";
...
export default async function ProfilePage() {
  ...
  const subscriptionInfo = await getSubscriptionPaymentInfo(userId, authToken);
  const paymentHistory = await getPaymentHistory(userId, authToken, "10");
